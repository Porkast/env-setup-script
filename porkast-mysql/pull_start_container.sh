echo "stop porkast-mysqldb"
docker stop porkast-mysqldb
echo "remove porkast-mysqldb container"
docker container rm porkast-mysqldb
echo "remove beegedelow/porkast-mysqldb image"
docker rmi beegedelow/porkast-mysqldb
echo "pull beegedelow/porkast-mysqldb image"
docker pull beegedelow/porkast-mysqldb
